{*
 * A11y One — clientareadomainregisterns.tpl
 * Register/modify/delete child nameserver forms: all inputs already have
 * explicit <label for> in the parent. The input-group suffix (.input-group-text)
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" class="form-control" id="inputNs1" name="ns" aria-describedby="inputNs1Suffix" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="inputNs1Suffix">. {$domain}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card-body">
        <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" class="form-control" id="inputNs2" name="ns" aria-describedby="inputNs2Suffix" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="inputNs2Suffix">. {$domain}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card-body">
        <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" class="form-control" id="inputNs3" name="ns" aria-describedby="inputNs3Suffix" />
                        <div class="input-group-append">
                            <span class="input-group-text" id="inputNs3Suffix">.{$domain}</span>
                        </div>
                    </div>
                </div>
            </div>
