...
<span class="sr-only">{if $type eq "error" or $type eq "danger"}{lang key='error'}{elseif $type eq "warning"}{lang key='warning'}{elseif $type eq "success"}{lang key='success'}{else}{lang key='information'}{/if}: </span>
{if $errorshtml}
