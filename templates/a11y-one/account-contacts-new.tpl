{* A11y One — account-contacts-new.tpl
   Parent: templates/twenty-one/account-contacts-new.tpl
   WS-B: Email preferences wrapped in fieldset/legend; contact select has
...
<div class="card">
    ...
    <div class="card">
        <div class="card-body">
            {* WS-B: fieldset/legend for email notification checkboxes *}
            <fieldset class="a11y-permissions">
                ...
                <div class="controls form-check">
                    {foreach $formdata.emailPreferences as $emailType => $value}
                        <label for="new{$emailType}Emails">
                        <input type="hidden" name="email_preferences[{$emailType}]" value="0">
                        <input type="checkbox" class="form-check-input" name="email_preferences[{$emailType}]" id="new{$emailType}Emails" value="1"{if $value} checked="checked"{/if} />
