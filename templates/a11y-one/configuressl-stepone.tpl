{* WS-D Task 3: configuressl-stepone — a11y-one override.
   Changes vs. parent (twenty-one/configuressl-stepone.tpl):
   - Server-type <select>: labelled (label for="inputServerType" already in parent; kept).
   - CSR <textarea>: labelled (label for="inputCsr" already in parent; kept); aria-required added.
   - Server-type <select>: aria-required added.
   - Additional-fields <fieldset>: added <legend> using the heading text (parent only had <strong>).
   - Admin/address <fieldset>: added sr-only <legend> with ssladmininfo lang key.
   - Back button: aria-label clarifies what "back" returns to.
    ...
    <div class="card py-3">
        <div class="card-body text-center">
            ...
            <button type="button" onclick="history.go(-1)" class="btn btn-primary"
                    aria-label="{lang key='clientareabacklink'}">
            ...
            <div class="card-body">
                ...
                {if $status eq "Awaiting Configuration"}
                    ...
                    <div class="form-group pt-3">
                        ...
                        <select name="servertype" id="inputServerType" class="custom-select" aria-required="true">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="csr" id="inputCsr" rows="7" class="form-control" aria-required="true">{if $csr}{$csr}{else}-----BEGIN CERTIFICATE REQUEST-----
-----END CERTIFICATE REQUEST-----{/if}</textarea>
                    </div>

                    {foreach $additionalfields as $heading => $fields}
                        <fieldset>
                            <legend class="h6"><strong>{$heading}</strong></legend>
                            {foreach $fields as $vals}
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right">{$vals.name}</label>
                                    <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h2 class="card-title" id="sslAdminInfoHeading">{lang key='ssladmininfo'}</h2>

                    {include file="$template/includes/alert.tpl" type="info" msg={lang key='ssladmininfodetails'}}

                    {* fieldset/legend groups the admin + address fields for AT *}
                    <fieldset class="pt-3" aria-labelledby="sslAdminInfoHeading">
                        <legend class="sr-only">{lang key='ssladmininfo'}</legend>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-md-right" for="inputFirstName">{lang key='clientareafirstname'}</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="firstname" id="inputFirstName" value="{$firstname}" autocomplete="given-name" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lastname" id="inputLastName" value="{$lastname}" autocomplete="family-name" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="orgname" id="inputOrgName" value="{$orgname}" autocomplete="organization" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jobtitle" id="inputJobTitle" value="{$jobtitle}" autocomplete="organization-title" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="email" id="inputEmail" value="{$email}" autocomplete="email" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="address1" id="inputAddress1" value="{$address1}" autocomplete="address-line1" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="address2" id="inputAddress2" value="{$address2}" autocomplete="address-line2" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="city" id="inputCity" value="{$city}" autocomplete="address-level2" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="state" id="inputState" value="{$state}" autocomplete="address-level1" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="postcode" id="inputPostcode" value="{$postcode}" autocomplete="postal-code" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="country" id="inputCountry" class="custom-select" autocomplete="country">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="tel" class="form-control" name="phonenumber" id="inputPhoneNumber" value="{$phonenumber}" autocomplete="tel" />
                            </div>
                        </div>
