{*
 * A11y One — clientareadomaindetails.tpl
 * Tab panels get role=tabpanel + tabindex + aria-label; unpaid-invoice alert
 * gets role=alert; nameserver radio group wrapped in fieldset/legend;
...
{if $unpaidInvoice}
    <div class="alert alert-{if $unpaidInvoiceOverdue}danger{else}warning{/if}" id="alert{if $unpaidInvoiceOverdue}Overdue{else}Unpaid{/if}Invoice" role="alert">
...
<div class="tab-content margin-bottom">
    <div class="tab-pane fade show active" id="tabOverview" tabindex="0" aria-label="{lang key='overview'}">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <a href="http://{$domain}" target="_blank" rel="noopener">{$domain} <span class="sr-only">({lang key='a11yOpensInNewWindow'})</span></a>
                    </div>
                    <div class="col-lg-6">
    ...
    <div class="tab-pane fade" id="tabAutorenew" tabindex="0" aria-label="{lang key='domainsautorenew'}">
    ...
    <div class="tab-pane fade" id="tabNameservers" tabindex="0" aria-label="{lang key='domainnameservers'}">
                ...
                <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domaindetails#tabNameservers">
                    ...
                    <fieldset>
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="nschoice" id="nsChoiceDefault" value="default" onclick="disableFields('domnsinputs',true)"{if $defaultns} checked{/if} />
                            <label class="form-check-label" for="nsChoiceDefault">{lang key='nschoicedefault'}</label>
                        </div>
                        <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" name="nschoice" id="nsChoiceCustom" value="custom" onclick="disableFields('domnsinputs',false)"{if !$defaultns} checked{/if} />
                            <label class="form-check-label" for="nsChoiceCustom">{lang key='nschoicecustom'}</label>
                        </div>
                    </fieldset>
    ...
    <div class="tab-pane fade" id="tabReglock" tabindex="0" aria-label="{lang key='domainregistrarlock'}">
    ...
    <div class="tab-pane fade" id="tabRelease" tabindex="0" aria-label="{lang key='domainrelease'}">
    ...
    <div class="tab-pane fade" id="tabAddons" tabindex="0" aria-label="{lang key='domainaddons'}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                {if $addons.emailforwarding}
                    ...
                    <div class="row mb-3">
                        <div class="col-3 col-md-2 text-center">
                            <i class="fas fa-envelope fa-3x" aria-hidden="true">&nbsp;</i><i class="fas fa-share fa-2x" aria-hidden="true"></i>
                        </div>
                        <div class="col-9 col-md-10">
