{* WS-G homepage.tpl
   Base: templates/twenty-one/homepage.tpl
   Parent: twenty-one (NOT six)
   A11y fixes:
   - Action icon card links: icon inside <figure> is decorative — aria-hidden on <i>.
     Link text already present as visible text child, so no sr-only needed.
   - Heading structure: <h2> sections already correct in parent; preserved.
   - Loading gif in twitter block: alt="" (decorative).
   - Announcement "read more" links: sr-only context added (was ambiguous).
   - No new JS helpers needed; hideDecorativeIcons auto-runs on DOMReady. *}
...
<div class="row my-5 action-icon-btns">
    <div class="col-6 col-md-4 col-lg">
        <a href="{routePath('announcement-index')}" class="card-accent-teal">
            <figure class="ico-container" aria-hidden="true">
    ...
    <div class="col-6 col-md-4 col-lg">
        <a href="{routePath('download-index')}" class="card-accent-wisteria">
            <figure class="ico-container" aria-hidden="true">
    ...
    <div class="col-6 col-md-4 offset-md-2 offset-lg-0 col-lg">
        <a href="contact.php" class="card-accent-concrete">
            <figure class="ico-container" aria-hidden="true">
