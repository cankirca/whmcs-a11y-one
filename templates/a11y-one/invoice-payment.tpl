    ...
    <form id="frmPayment" method="post" action="{$submitLocation}" role="form">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title h3">{lang key="makepayment"}</h1>

                        <div id="paymentGatewayInput">
                            <div class="cc-payment-form">
                                <fieldset class="form-group row">
                                    <legend class="col-sm-4 text-md-right control-label col-form-label">
        ...
        {if $servedOverSsl}
            <div class="alert alert-warning" role="alert">
                <i class="fas fa-lock" aria-hidden="true"></i> &nbsp; {lang key='creditcardsecuritynotice'}
            </div>
        {/if}
