...
<div class="form-group row">
    ...
    <div class="col-sm-7">
        <input type="tel" name="cccvv" id="inputCardCvv" value="{$cccvv}" autocomplete="cc-csc" class="form-control input-inline input-inline-100" />
        <button id="cvvWhereLink" type="button" class="btn btn-link btn-sm" data-toggle="popover" data-content="<img src='{$BASE_PATH_IMG}/ccv.gif' width='210' alt='{lang key='creditcardcvvwhere'}'>" aria-label="{lang key='creditcardcvvwhere'}">
