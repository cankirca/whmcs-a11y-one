            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=confdomains" id="frmConfigureDomains">
                ...
                {foreach $domains as $num => $domain}
                    ...
                    {if $domain.dnsmanagement || $domain.emailforwarding || $domain.idprotection}
                        <fieldset class="row addon-products">
                            <legend class="sr-only">{$LANG.a11yCartDomainAddonsGroup}: {$domain.domain}</legend>
                ...
                {if $atleastonenohosting}
                    ...
                    <fieldset>
                        <div class="sub-heading">
                            <legend class="primary-bg-color">{$LANG.domainnameservers}</legend>
                        </div>
