        ...
        <div class="cart-body">
                                ...
                                <div class="input-group input-group-lg input-group-box">
                                    {if $showAdvancedSearchOptions}
                                        ...
                                        <button type="submit"
                                            ...
                                            {lang key='search'} <i class="fa-regular fa-sparkles" aria-hidden="true"></i>
                                        </button>
                                    ...
                                    {else}
                                        <label for="inputDomain" class="sr-only">{lang key='orderForm.domainOrKeyword'}</label>
                                    ...
                                    <div class="captcha-container" id="captchaContainer">
                                        ...
                                        {else}
                                            <div class="default-captcha default-captcha-register-margin">
                                                <p id="captchaInstruction">{lang key="cartSimpleCaptcha"}</p>
                                                <div>
                                                    <img id="inputCaptchaImage" src="{$systemurl}includes/verifyimage.php" align="middle" alt="{lang key='captchaverify'}" />
                                                    <label for="inputCaptcha" class="sr-only">{lang key="cartSimpleCaptcha"}</label>
                                                    <input id="inputCaptcha" type="text" name="code" maxlength="6" class="form-control input-sm" aria-describedby="captchaInstruction" data-toggle="tooltip" data-placement="right" data-trigger="manual" title="{lang key='orderForm.required'}" />
                                                </div>
                                            </div>
                                        {/if}
                                    </div>
            ...
            <div id="DomainSearchResults" class="w-hidden" role="status" aria-live="polite">
                ...
                <div id="searchDomainInfo" class="domain-checker-result-headline">
                    <p id="primaryLookupSearching" class="domain-lookup-loader domain-lookup-primary-loader domain-searching"><i class="fas fa-spinner fa-spin" aria-hidden="true"></i> {lang key='orderForm.searching'}...</p>
                    <div id="primaryLookupResult" class="domain-lookup-result w-hidden">
                        ...
                        <p class="domain-price">
                            ...
                            <button class="btn btn-primary btn-add-to-cart" data-whois="0" data-domain="" data-label-add="{$LANG.addtocart}" data-label-added="{lang key='checkout'}" data-label-unavailable="{$LANG.domaincheckertaken}">
                                <span class="to-add">{$LANG.addtocart}</span>
                                <span class="loading">
                                    <i class="fas fa-spinner fa-spin" aria-hidden="true"></i> {lang key='loading'}
                                </span>
                                <span class="added"><i class="far fa-shopping-cart" aria-hidden="true"></i> {lang key='checkout'}</span>
                                ...
                                <div class="spotlight-tld-container spotlight-tld-container-{$spotlightTlds|count}">
                                    <div id="spotlight{$data.tldNoDots}" class="spotlight-tld">
                                        ...
                                        <div class="domain-lookup-result">
                                            ...
                                            <button type="button" class="btn btn-add-to-cart w-hidden" data-whois="0" data-domain="" data-label-add="{lang key='orderForm.add'}" data-label-added="{lang key='checkout'}" data-label-unavailable="{$LANG.domaincheckertaken}">
                ...
                <div class="suggested-domains{if !$showSuggestionsContainer} w-hidden{/if}">
                    ...
                    <div id="domainSuggestions" class="domain-lookup-result list-group w-hidden">
                        <div class="domain-suggestion list-group-item w-hidden">
                            ...
                            <div class="actions">
                                <span class="price"></span>
                                <button type="button" class="btn btn-add-to-cart" data-whois="1" data-domain="" data-label-add="{$LANG.addtocart}" data-label-added="{lang key='checkout'}" data-label-unavailable="{$LANG.domaincheckertaken}">
                                    <span class="to-add">{$LANG.addtocart}</span>
                                    <span class="loading">
                                        <i class="fas fa-spinner fa-spin" aria-hidden="true"></i> {lang key='loading'}
                                    </span>
            ...
            <div class="row">
                <div class="{if $domainTransferEnabled}col-md-6{else}col-md-8 col-md-offset-2 offset-md-2{/if}">
                    <div class="domain-promo-box">
                        ...
                        <div class="clearfix">
                            <i class="fas fa-server fa-4x" aria-hidden="true"></i>
