                    ...
                    <div class="col-md-6">
                        <div class="product clearfix" id="product{$num}">
                            <form method="post" action="{$smarty.server.PHP_SELF}?a=add" class="form-inline">
                                ...
                                <header class="col-12">
                                    <span id="addonName{$num}">{$addon.name}</span>
                                </header>
                                <div class="product-desc product-desc-full-width">
                                    <p>{$addon.description|nl2br}</p>
                                    <div class="form-group">
                                        <label for="inputProductId{$num}" class="sr-only">{$addon.name} &ndash; {$LANG.cartchooseproduct}</label>
                                ...
                                <footer class="col-12 text-right">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm" aria-describedby="addonName{$num}">
