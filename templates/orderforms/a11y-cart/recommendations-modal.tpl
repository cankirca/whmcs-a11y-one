...
{/if}
<div class="modal fade" id="recommendationsModal" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="recommendationsModalTitle">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="float-left pull-left" id="recommendationsModalTitle">
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" href="#" id="btnContinueRecommendationsModal" data-dismiss="modal" role="button">
                    <span class="w-hidden hidden"><i class="fas fa-spinner fa-spin" aria-hidden="true"></i>&nbsp;</span>{lang key="continue"}
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="header">
            <div class="cta">
                ...
                <button type="button" class="btn btn-sm btn-add">
                    ...
                    <span class="arrow"><i class="fas fa-chevron-right" aria-hidden="true"></i></span>
                </button>
            </div>
            <div class="expander">
                <i class="fas fa-chevron-right rotate" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="{lang key="recommendations.learnMore"}"></i>
            </div>
            <div class="content">
