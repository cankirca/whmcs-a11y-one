                ...
                <div class="row">
                    <div class="secondary-cart-body">
                        ...
                        {if $productinfo.type eq "server"}
                            <fieldset>
                                <div class="sub-heading">
                                    <legend class="primary-bg-color">{$LANG.cartconfigserver}</legend>
                                </div>
                                    ...
                                    {elseif $configoption.optiontype eq 2}
                                        <div class="col-sm-6">
                                            <fieldset class="form-group">
                                                <legend class="col-form-label">{$configoption.optionname}</legend>
                                                {foreach key=num2 item=options from=$configoption.options}
                                                    <label class="d-block">
                        ...
                        {if $addons || count($addonsPromoOutput) > 0}
                            ...
                            <div id="productAddonsContainer">
                                <fieldset>
                                    <div class="sub-heading">
                                        <legend class="primary-bg-color">{$LANG.cartavailableaddons}</legend>
                                    </div>
                                        ...
                                        {foreach $addons as $addon}
                                            <div class="col-sm-{if count($addons) > 1}6{else}12{/if}">
                                                <div class="panel card panel-default panel-addon{if $addon.status} panel-addon-selected{/if}">
                                                    ...
                                                    <div class="panel-add" aria-hidden="true">
                    ...
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        ...
                        <div id="orderSummary">
                            <div class="order-summary">
                                ...
                                <div class="summary-container" id="producttotal" aria-live="polite" aria-atomic="true" role="status"></div>
                            </div>
