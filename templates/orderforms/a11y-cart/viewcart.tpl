...
{else}
    ...
    <div id="order-standard_cart">
            ...
            <div class="cart-body">
                ...
                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            {if $showqtyoptions}
                                                <div class="col-sm-2 item-qty">
                                                    {if $product.allowqty}
                                                        <label for="qty_p_{$num}" class="sr-only">{$LANG.a11yCartQuantityFor|sprintf2:$product.productinfo.name}</label>
                                                        <input type="number" id="qty_p_{$num}" name="qty[{$num}]" value="{$product.qty}" class="form-control text-center" min="0" />
                                        ...
                                        <div class="item">
                                            <div class="row">
                                                ...
                                                {if $showAddonQtyOptions}
                                                    <div class="col-sm-2 item-qty">
                                                        {if $addon.allowqty === 2}
                                                            <label for="paddonqty_{$num}_{$addonnum}" class="sr-only">{$LANG.a11yCartQuantityFor|sprintf2:$addon.name}</label>
                                                            <input type="number" id="paddonqty_{$num}_{$addonnum}" name="paddonqty[{$num}][{$addonnum}]" value="{$addon.qty}" class="form-control text-center" min="0" />
                                                            <button type="submit" class="btn btn-xs">
                                                                {$LANG.orderForm.update}
                                                            </button>
                                                        {/if}
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            {if $showAddonQtyOptions}
                                                <div class="col-sm-2 item-qty">
                                                    {if $addon.allowqty === 2}
                                                        <label for="addonqty_{$num}" class="sr-only">{$LANG.a11yCartQuantityFor|sprintf2:$addon.name}</label>
                                                        <input type="number" id="addonqty_{$num}" name="addonqty[{$num}]" value="{$addon.qty}" class="form-control text-center" min="0" />
                                                        <button type="submit" class="btn btn-xs">
                                                            {$LANG.orderForm.update}
                                                        </button>
                                                    {/if}
                                ...
                                {foreach $upgrades as $num => $upgrade}
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            {if $showUpgradeQtyOptions}
                                                <div class="col-sm-2 item-qty">
                                                    {if $upgrade->allowMultipleQuantities}
                                                        <label for="upgradeqty_{$num}" class="sr-only">{$LANG.a11yCartQuantityFor|sprintf2:$upgrade->newProduct->name}</label>
                                                        <input type="number" id="upgradeqty_{$num}" name="upgradeqty[{$num}]" value="{$upgrade->qty}" class="form-control text-center" min="{$upgrade->minimumQuantity}" />
                                                        <button type="submit" class="btn btn-xs">
                                                            {$LANG.orderForm.update}
                                                        </button>
                                                    {/if}
                                            ...
                                            <div class="col-sm-1">
                                                <button type="button" class="btn btn-link btn-xs btn-remove-from-cart" onclick="removeItem('u','{$num}')" aria-label="{$LANG.orderForm.remove}: {$LANG.upgrade}">
                                                    <i class="fas fa-times" aria-hidden="true"></i>
                                                    <span class="visible-xs d-block d-sm-none">{$LANG.orderForm.remove}</span>
                                                </button>
                                            </div>
                                    ...
                                    {else}
                                        <form method="post" action="{$WEB_ROOT}/cart.php?a=view">
                                            <div class="form-group">
                                                <label for="inputPromotionCode">{$LANG.a11yCartPromoCodeLabel}</label>
                    ...
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        ...
                        <div class="order-summary" id="orderSummary" role="status" aria-live="polite" aria-atomic="true" aria-label="{$LANG.a11yCartOrderSummaryRegion}">
                            <div class="loader w-hidden" id="orderSummaryLoader">
                                <i class="fas fa-fw fa-sync fa-spin" aria-hidden="true"></i>
                            </div>
                            ...
                            <div class="summary-container">
                                ...
                                <div class="text-right">
                                    <a href="{$WEB_ROOT}/cart.php?a=checkout&e=false" class="btn btn-success btn-lg btn-checkout{if $cartitems == 0} disabled{/if}" id="checkout"{if $cartitems == 0} aria-disabled="true" role="button"{/if}>
        ...
        <form method="post" action="{$WEB_ROOT}/cart.php">
            ...
            <div class="modal fade modal-remove-item" id="modalRemoveItem" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="modalRemoveItemTitle">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <h4 class="modal-title margin-bottom mb-3" id="modalRemoveItemTitle">
        ...
        <form method="post" action="{$WEB_ROOT}/cart.php">
            ...
            <div class="modal fade modal-remove-item" id="modalEmptyCart" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="modalEmptyCartTitle">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="float-right">
                            ...
                            <h4 class="modal-title margin-bottom mb-3" id="modalEmptyCartTitle">
                                <i class="fas fa-trash-alt fa-3x" aria-hidden="true"></i>
                                <span>{$LANG.emptycart}</span>
                            </h4>
